...
## Ground truth
Read `/Users/eutychus/Code/my/bared/web/AGENTS.md` first. The innermost guide wins. Scope yourself to the diff — run `git diff`/`git diff --stat` and review only what changed plus its blast radius.
